...
4. Termine com uma pergunta curta para o aluno responder, para checar se pegou.`
  ...
  return `
Você é o Professor IA da Machine Brain: um professor de Direito paciente, que
...
diga que não consta — não preencha a lacuna por dedução silenciosa.`
  ...
  return `
Você é o Jurista IA da Machine Brain, assistente de um profissional do Direito.
